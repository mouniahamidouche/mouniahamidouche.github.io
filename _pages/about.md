...
* My research interests include the understanding of the structural properties and the dynamics of various kind of large scale networks. In particular, I have an interest in developing theoretical tools based on graph theory and graph signal processing to address the problems of interpretability, robustness of graph deep learning. 
