...
* My research interests include understanding the structural properties and the dynamics of various types of large scale networks. In particular, I am interested in developing theoretical tools based on graph theory and graph signal processing to address the problems of interpretability, robustness of graph deep learning. 
